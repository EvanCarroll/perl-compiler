...
sub savecowpv {
    ...
    $cowtable{$cstring} = [ $pvsym, $cur, $len, $utf8, $cstring ];

    return ( $pvsym, $cur, $len, $utf8, $cstring );    # NOTE: $cur is total size of the perl string. len would be the length of the C string.
}
